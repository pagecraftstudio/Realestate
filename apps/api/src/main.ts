...
import { propertyMatchingRoutes } from './modules/property-matching/property-matching.routes.js'
...
export async function buildApp() {
  ...
  await fastify.register(
    async (api) => {
      ...
      // Phase 18 — Campaigns / Marketing
      await api.register(campaignsRoutes, { prefix: '/campaigns' })
      // Phase 19 — Contracts
      await api.register(contractsRoutes, { prefix: '/contracts' })
      // Phase 20 — Property Matching
      await api.register(propertyMatchingRoutes, { prefix: '/property-matching' })
