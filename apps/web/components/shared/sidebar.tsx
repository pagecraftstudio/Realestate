...
const NAV_GROUPS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Property Matching',  href: '/property-matching',  icon: Wand2 },
  ...
  },
  {
    label: 'Admin',
    items: [
      { label: 'Marketing',    href: '/marketing',    icon: Megaphone,  roles: ['COMPANY_ADMIN', 'SALES_MANAGER', 'SUPER_ADMIN', 'MARKETING_MANAGER'] },
